class AddTdFieldsToProjects < ActiveRecord::Migration[7.0]
  def change
    add_column :projects, :td_severity_value, :integer, default: 1
    add_column :projects, :td_labour_rate, :float, default: 75
    add_column :projects, :td_estimated_time, :float, default: 1
    ...
    add_column :projects, :td_payback_likelihood_low, :float, default: 0.2
